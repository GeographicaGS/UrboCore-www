...
App.View.Map.LayerTree.View = Backbone.View.extend({
  ...
  initialize: function (options) {
    ...
    // Enabled o disabled filter
    this.listenTo(App.ctx, 'change:mapTooltipIsShow', this._enabledFilter);
  },
   ...
   * 
   * @param {Boolean} enabled - activa o desactiva el filtro
   */
  _enabledFilter: function () {
    this.$el.toggleClass('disabled', App.ctx.getMapTooltipIsShow());
  },
